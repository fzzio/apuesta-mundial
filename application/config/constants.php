...
defined('ORDEN_DESCENDENTE')	OR define('ORDEN_DESCENDENTE', 'DESC');
...
defined('COSTO_APUESTA_FASE_GRUPOS')		OR define('COSTO_APUESTA_FASE_GRUPOS', 0.10);
defined('COSTO_APUESTA_FASE_OCTAVOS')		OR define('COSTO_APUESTA_FASE_OCTAVOS', 0.20);
defined('COSTO_APUESTA_FASE_CUARTOS')		OR define('COSTO_APUESTA_FASE_CUARTOS', 0.30);
defined('COSTO_APUESTA_FASE_SEMIFINAL')		OR define('COSTO_APUESTA_FASE_SEMIFINAL', 0.40);
defined('COSTO_APUESTA_FASE_TERCERO')		OR define('COSTO_APUESTA_FASE_TERCERO', 0.40);
defined('COSTO_APUESTA_FASE_FINAL')			OR define('COSTO_APUESTA_FASE_FINAL', 0.50);

defined('PRONOSTICO_NO_DISPONIBLE')		OR define('PRONOSTICO_NO_DISPONIBLE', 0);
...
defined('PRONOSTICO_ACIERTO')			OR define('PRONOSTICO_ACIERTO', 4);
defined('PRONOSTICO_DESACIERTO')		OR define('PRONOSTICO_DESACIERTO', 5);

defined('RESULTADO_GANASTE')		OR define('RESULTADO_GANASTE', 1);
defined('RESULTADO_PERDISTE')		OR define('RESULTADO_PERDISTE', 2);
defined('RESULTADO_NADIE_GANA')		OR define('RESULTADO_NADIE_GANA', 3);
defined('RESULTADO_DESIERTA')		OR define('RESULTADO_DESIERTA', 4);
defined('RESULTADO_PENDIENTE')		OR define('RESULTADO_PENDIENTE', 5);
defined('RESULTADO_GANA_LOCAL')		OR define('RESULTADO_GANA_LOCAL', 6);
defined('RESULTADO_GANA_VISITANTE')	OR define('RESULTADO_GANA_VISITANTE', 7);
