...
defined('COSTO_APUESTA_FASE_GRUPOS')		OR define('COSTO_APUESTA_FASE_GRUPOS', 0.20);
defined('COSTO_APUESTA_FASE_OCTAVOS')		OR define('COSTO_APUESTA_FASE_OCTAVOS', 0.30);
defined('COSTO_APUESTA_FASE_CUARTOS')		OR define('COSTO_APUESTA_FASE_CUARTOS', 0.40);
defined('COSTO_APUESTA_FASE_SEMIFINAL')		OR define('COSTO_APUESTA_FASE_SEMIFINAL', 0.50);
defined('COSTO_APUESTA_FASE_TERCERO')		OR define('COSTO_APUESTA_FASE_TERCERO', 0.40);
defined('COSTO_APUESTA_FASE_FINAL')			OR define('COSTO_APUESTA_FASE_FINAL', 1);
